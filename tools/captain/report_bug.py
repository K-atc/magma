...
import argparse
parser = argparse.ArgumentParser(description='Read count of reached/triggered bugs from monitor directory')
...
for target in glob.glob(f"{args.work_dir}/*/aflplusplus/*"):
    if args.debug:
